 ...
 */
public class PlayRickrollCmd extends DJCommand
{
    private final String loadingEmoji;

    public PlayRickrollCmd(Bot bot)
    {
        super(bot);
        this.loadingEmoji = bot.getConfig().getLoading();
        this.name = "rickroll";
        this.help = "never gonna give you up";
    ...
    private class ResultHandler implements AudioLoadResultHandler
    {
        ...
        private void loadSingle(AudioTrack track)
        {
            ...
            String addMsg = FormatUtil.filter(event.getClient().getSuccess()+" nothing sus here (among us)");
